...
class _AuthenticationScreenState extends State<AuthenticationScreen>
  ...
  void resetPasswordRequest() {
    ...
    // Here you would typically make an HTTP request, but we're simulating it
    // with a delay
  ...
  void showAlertDialog(BuildContext context) {
    // Simulate showing an alert dialog
        ...
        Center(
          child: Column(
            children: [
              ...
              isRequesting == false
                  ? buildGlobalButton(
                      buttonPress: resetPasswordRequest,
                      buttonLabel: 'Submit',
  ...
  void registerHsp() {
    ...
    // Simulate HTTP request
    Future.delayed(Duration(seconds: 2), () {
      // Navigate to account verification screen on successful registration
      Navigator.of(context).pushAndRemoveUntil(
...
void initState() {
  ...
  // void initState() {
  //   _tabController = TabController(length: 2, vsync: this);
  //   // Simulate getting service categories
